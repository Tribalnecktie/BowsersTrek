...
public class altRoomLibrary {

	public altRoomLibrary()
	{
		ArrayList<String> adjRoom;
		adjRoom.addAll(Arrays.asList("HW_L1"));
		altRoom rm101 = new altRoom ("RM101", getRmDescript("RM101"), adjRoom);
		adjRoom.removeAll();
		adjRoom.addAll(Arrays.asList("Room 101", "Room 102", "Room 103", "Room 104", "Room 105"))
		altRoom hw_L1 = new altRoom ("HW_L1", getRmDescript("HW_L1"), )
	}
