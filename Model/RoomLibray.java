...
public class RoomLibray {
	 ...
	 **/
	public static class RoomLibrary extends Room2 {

		private Map<String,Room2> roomsAL = new HashMap<String,Room2>();
		 ...
		 */
		public Map<String, Room2> roomsAL() {


			//LEVEL ONE ROOMS ADD TO ARRAY --> 7 Rooms
			roomsAL.put("RM101", (new Room2(1, "RM101", "DR101 and DR102", "Entrance", super.getMonsterObj(), super.getPuzzleObj(), super.getArtifactObj(), super.getPlayerID())));
			roomsAL.put("HW_L1", (new Room2(1, "HW_L1", "DR101, DR102,DR103, DR104, DR105, DR106, DR107, DR108", "Hallway Level 1", super.getMonsterObj(), super.getPuzzleObj(), super.getArtifactObj(), super.getPlayerID())));
			roomsAL.put("RM102", (new Room2(1, "RM102", "DR103", "Greeting Area", super.getMonsterObj(), super.getPuzzleObj(), super.getArtifactObj(), super.getPlayerID())));
			roomsAL.put("RM103", (new Room2(1, "RM103", "DR104", "Living Room", super.getMonsterObj(), super.getPuzzleObj(), super.getArtifactObj(), super.getPlayerID())));
			roomsAL.put("RM104", (new Room2(1, "RM104", "DR105", "Game Room", super.getMonsterObj(), super.getPuzzleObj(), super.getArtifactObj(), super.getPlayerID())));
			roomsAL.put("RM105", (new Room2(1, "RM105", "DR106", "Kitchen", super.getMonsterObj(), super.getPuzzleObj(), super.getArtifactObj(), super.getPlayerID())));
			roomsAL.put("RM106", (new Room2(1, "RM106", "DR107", "Dining Room", super.getMonsterObj(), super.getPuzzleObj(), super.getArtifactObj(), super.getPlayerID())));
			roomsAL.put("RM107", (new Room2(1, "RM107", "DR108", "Landing", super.getMonsterObj(), super.getPuzzleObj(), super.getArtifactObj(), super.getPlayerID())));

			//LEVEL TWO ROOMS ADDED TO ARRAY  --> 7 Rooms
			roomsAL.put("HW_L2", (new Room2(2, "HW_L2", "DR201, DR202, DR203, DR205, DR208, DR209, DR211, DR212", "Hallway Level 2", super.getMonsterObj(), super.getPuzzleObj(), super.getArtifactObj(), super.getPlayerID())));
			roomsAL.put("RM201", (new Room2(2, "RM201", "DR 201, DR202, DR203, DR204", "Waiting Room", super.getMonsterObj(), super.getPuzzleObj(), super.getArtifactObj(), super.getPlayerID())));
			roomsAL.put("RM202", (new Room2(2, "RM202", "DR205", "Supply Room", super.getMonsterObj(), super.getPuzzleObj(), super.getArtifactObj(), super.getPlayerID())));
			roomsAL.put("RM203", (new Room2(2, "RM203", "DR206, DR207", "Bedroom", super.getMonsterObj(), super.getPuzzleObj(), super.getArtifactObj(), super.getPlayerID())));
			roomsAL.put("RM204", (new Room2(2, "RM204", "DR207, DR208", "Cleaning Supply Room", super.getMonsterObj(), super.getPuzzleObj(), super.getArtifactObj(), super.getPlayerID())));
			roomsAL.put("RM205", (new Room2(2, "RM205", "DR209, DR206", "Music Room", super.getMonsterObj(), super.getPuzzleObj(), super.getArtifactObj(), super.getPlayerID())));
			roomsAL.put("RM206", (new Room2(2, "RM206", "DR210, DR211", "Wine Cellar", super.getMonsterObj(), super.getPuzzleObj(), super.getArtifactObj(), super.getPlayerID())));
			roomsAL.put("RM207", (new Room2(2, "RM207", "DR204, DR212", "Library", super.getMonsterObj(), super.getPuzzleObj(), super.getArtifactObj(), super.getPlayerID())));

			//LEVEL THREE ROOMS ADDED TO ARRAY --> 6 Rooms
			roomsAL.put("HW_L3", (new Room2(3, "HW_L3", "DR300, DR301, DR302, DR303, DR304, DR306, DR307", "Hallway Level 3", super.getMonsterObj(), super.getPuzzleObj(), super.getArtifactObj(), super.getPlayerID())));
			roomsAL.put("RM301", (new Room2(3, "RM301", "DR300, DR301", "Colorful Room", super.getMonsterObj(), super.getPuzzleObj(), super.getArtifactObj(), super.getPlayerID())));
			roomsAL.put("RM302", (new Room2(3, "RM302", "DR302, DR303", "Library", super.getMonsterObj(), super.getPuzzleObj(), super.getArtifactObj(), super.getPlayerID())));
			roomsAL.put("RM303", (new Room2(3, "RM303", "DR306, DR307", "Work Room", super.getMonsterObj(), super.getPuzzleObj(), super.getArtifactObj(), super.getPlayerID())));
			roomsAL.put("RM304", (new Room2(3, "RM304", "DR304, DR305", "TV Room", super.getMonsterObj(), super.getPuzzleObj(), super.getArtifactObj(), super.getPlayerID())));
			roomsAL.put("RM305", (new Room2(3, "RM305", "DR315, DR316", "Red Chest Room", super.getMonsterObj(), super.getPuzzleObj(), super.getArtifactObj(), super.getPlayerID())));

			//LEVEL FOUR ROOMS ADDED TO ARRAY --> 8 Rooms
			roomsAL.put("HW_L4", (new Room2(4, "HW_L4", "DR401, DR402, DR403, DR405, DR407, DR408, DR409", "Hallway Level 4", super.getMonsterObj(), super.getPuzzleObj(), super.getArtifactObj(), super.getPlayerID())));
			roomsAL.put("RM401", (new Room2(4, "RM401", "DR401", "Game Room", super.getMonsterObj(), super.getPuzzleObj(), super.getArtifactObj(), super.getPlayerID())));
			roomsAL.put("RM402", (new Room2(4, "RM402", "DR402", "Study Room", super.getMonsterObj(), super.getPuzzleObj(), super.getArtifactObj(), super.getPlayerID())));
			roomsAL.put("RM403", (new Room2(4, "RM403", "DR403, DR404", "Dream Room", super.getMonsterObj(), super.getPuzzleObj(), super.getArtifactObj(), super.getPlayerID())));
			roomsAL.put("RM404", (new Room2(4, "RM404", "DR405, DR406", "Garden Room", super.getMonsterObj(), super.getPuzzleObj(), super.getArtifactObj(), super.getPlayerID())));
			roomsAL.put("RM405", (new Room2(4, "RM405", "DR406, DR407", "Theater Room", super.getMonsterObj(), super.getPuzzleObj(), super.getArtifactObj(), super.getPlayerID())));
			roomsAL.put("RM406", (new Room2(4, "RM406", "DR408", "Dining Room", super.getMonsterObj(), super.getPuzzleObj(), super.getArtifactObj(), super.getPlayerID())));
			roomsAL.put("RM407", (new Room2(4, "RM407", "DR409", "Dark Room", super.getMonsterObj(), super.getPuzzleObj(), super.getArtifactObj(), super.getPlayerID())));
		...
		public String printRoomInfo() {
			System.out.println();
			String currentRM = super.getRmId();
			String str = "You are on Level: " + super.getRmLevel() + ".  You're in Room: " + super.getRmId() + " --> " + super.getRmName() + ".  It's Doors are: " + super.getRmDoor() + ".\n"
			 + "Rooms' Monster is: " +  super.getMonsterObj() + ".\n" + "Rooms' Puzzle is: " + super.getPuzzleObj() + ".\n"
			 + "Rooms' Artifact is: " + super.getArtifactObj() + "Room Descript: " + getRmDescript(currentRM);

			console.printConsoleView(str);
			
				
			Set<Entry<String, Room2>> keyValueSet = roomsAL.entrySet();  
			
			System.out.println("\nSorted Map:");
			System.out.println(keyValueSet.equals(getRmDescript("RM104")));
			
		
			for (Entry<String, Room2> entry : keyValueSet) 
			{
